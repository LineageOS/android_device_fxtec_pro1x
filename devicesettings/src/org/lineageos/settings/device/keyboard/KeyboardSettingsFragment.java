...
public class KeyboardSettingsFragment extends PreferenceFragment
    ...
    private SwitchPreference mKeymapGravePref;
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        mKeymapGravePref = findPreference(Constants.KEYBOARD_KEYMAP_GRAVE_KEY);
    ...
    public void onSharedPreferenceChanged(SharedPreferences prefs, String key) {
        switch (key) {
            ...
            case Constants.KEYBOARD_KEYMAP_GRAVE_KEY:
                doUpdateKeymapPreferences();
                break;
        }
    }
    ...
    private void doUpdateKeymapPreferences() {
        ...
        mKeymapGravePref.setEnabled(true);
        ...
        if (mKeymapCustomPref.isChecked()) {
            if (KeyboardUtils.installCustomKeymap()) {
                ...
                mKeymapGravePref.setChecked(false);
                mKeymapGravePref.setEnabled(false);
            } else {
                mKeymapCustomPref.setChecked(false);
        ...
        if (mKeymapGravePref.isChecked()) {
            for (int i = 0; i < Constants.KEYBOARD_KEYMAP_GRAVE_TEXT.length; ++i) {
               KeyboardUtils.writeFile(Constants.KEYBOARD_KEYMAP_SYS_FILE,
                        Constants.KEYBOARD_KEYMAP_GRAVE_TEXT[i] + "\n");
            }
            mKeymapCustomPref.setChecked(false);
        }
    }
